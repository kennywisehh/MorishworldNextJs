...
export const serviceHighlights = [
  {
    ...
    blurb: "Full-service dining for your reception, from tasting to teardown.",
    href: "/services#wedding",
  },
  {
    icon: "cake",
    title: "Birthday Parties",
    blurb: "Custom cakes and menus built around the guest of honor.",
    href: "/services#birthday",
  },
  {
    icon: "briefcase",
    title: "Corporate Catering",
    blurb: "Reliable, on-time service for meetings, launches, and galas.",
    href: "/services#corporate",
  },
  {
    icon: "sparkles",
    title: "Private Events",
    blurb: "Intimate dinners and gatherings, cooked fresh on the day.",
    href: "/services#private",
  },
];

export const whyChooseUs = [
  "Fresh, same-day cooking — never reheated",
  "Fully customizable menus for any dietary need",
...
export const howItWorks = [
  {
    ...
    text: "Tell us your event date, guest count, and what you're picturing.",
  },
  {
    step: "02",
    title: "Get a quote",
    text: "We reach out within 24 hours to talk menu, budget, and logistics.",
  },
  {
    step: "03",
    title: "Confirm your date",
    text: "Sign off on the menu and secure your date with a deposit.",
  },
  {
    step: "04",
    title: "We handle the rest",
    text: "Setup, service, and cleanup — you just enjoy the event.",
  },
];

export const contactInfo = {
  phone: "07030309775",
  whatsapp: "2347030309775",
  email: "morishworld08@gmail.com",
